...
main_menu.add('🔍 Найти user', '🤝 Мои сделки', '🎩Профиль', '🎁 Пожертвовать', '💬 Помощь')
main_menu.add('🥷 Акции')
...
donat_keyboard.add(types.InlineKeyboardButton(text='⚔️Стать орденом', url='https://t.me/Laly_4shop_bot'))
...
update_name.add(
	types.InlineKeyboardButton(text='Есть вопрос?', url='https://t.me/Lyaxovskiy'),
	types.InlineKeyboardButton(text='🏦 Доступные акции', url='how'),
	types.InlineKeyboardButton(text='🥷 Акция', callback_data='how'),
